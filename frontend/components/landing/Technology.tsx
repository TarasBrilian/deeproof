        ...
        <section id="technology" className="mb-32">
            <Container>
                <div className="text-center mb-16 px-4">
                    <h2 className="font-display font-bold text-3xl md:text-4xl mb-6">The Hybrid Oracle Architecture</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card>
                        ...
                        <h3 className="font-display font-semibold text-xl mb-3">Blind Hashing</h3>
                    ...
                    <Card>
                        ...
                        <h3 className="font-display font-semibold text-xl mb-3">Just-in-Time Signing</h3>
                        <p className="text-code-grey text-sm leading-relaxed">
                    ...
                    <Card>
                        ...
                        <h3 className="font-display font-semibold text-xl mb-3">On-Chain Settlement</h3>
                        <p className="text-code-grey text-sm leading-relaxed">
